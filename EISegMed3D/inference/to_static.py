...
def main():
    ...
    new_net = paddle.jit.to_static(
        ...
        input_spec=[
            ...
            paddle.static.InputSpec(shape=[None, 3, None, None, None], dtype="float32"),  # 16, 48, 4
        ],
    )
    ...
    with open(yml_file, "w") as file:
        data = {"Deploy": {"model": "static_Vnet_model.pdmodel", "params": "static_Vnet_model.pdiparams"}}
        yaml.dump(data, file)
